...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   mandelbrotset_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: rhafidi <rhafidi@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/22 19:23:13 by rhafidi           #+#    #+#             */
/*   Updated: 2025/02/25 18:05:45 by rhafidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	my_pixel_put(t_data *img, int x, int y, int keycode)
{
	char	*offset;
	double	new_x;
	double	new_y;
...
void	display_mandelbortset(t_mlx_data *mlx, t_data *img, int keycode)
{
	my_pixel_put(img, 0, 0, keycode);
