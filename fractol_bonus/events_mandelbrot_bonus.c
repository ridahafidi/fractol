...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/22 19:24:46 by rhafidi           #+#    #+#             */
/*   Updated: 2025/02/25 17:49:57 by rhafidi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol_bonus.h"

int	handle_mouse_for_mandelbrot(int button, int x, int y, t_mlx_data *mlx)
{
	double	zoom_factor;
	double	mouse_x;
	double	mouse_y;
	...
	display_mandelbortset(mlx, mlx->img, mlx->img->current_color);
	return (0);
}
